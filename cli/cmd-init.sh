...
# Ignores fleet's per-project generated files. Idempotent: creates the file
# if missing; if present, appends any required lines that are not already
# there (preserves user customisations).
  ...
  if [ ! -f "${gi}" ]; then
    {
      ...
      echo '# These are regenerable or machine-specific; do not commit.'
